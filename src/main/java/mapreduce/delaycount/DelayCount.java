...
public class DelayCount extends Configured implements Tool {
    ...
    public static final String OUTPUT_PATH = "/dataexpo/2009/output-overall";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(globalConf, new DelayCount(), args);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job conf = Job.getInstance(getConf(), "DelayCount");

        conf.setJarByClass(getClass());

        conf.setMapperClass(DelayCountMapper.class);
